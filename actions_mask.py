...
dic_sum_True = {}
dic_sum_True['segmentation'], dic_sum_True['runtime'], dic_sum_True['nodeData'], dic_sum_True['edgeData'], _ = utility.gasp(mask_avg_geometry, run_GASP_kwargs, mask_avg_aff_small)
...
plt.title('GASP Actions, SumTrue, MaskAff')
plt.legend()
plt.show()
...
run_GASP_kwargs = {'linkage_criteria': 'avg',
                   'add_cannot_link_constraints': True}
dic_avg_True = {}
dic_avg_True['segmentation'], dic_avg_True['runtime'], dic_avg_True['nodeData'], dic_avg_True['edgeData'], _ = utility.gasp(mask_avg_geometry, run_GASP_kwargs, mask_avg_aff_small)
...
plt.xlabel('Interval of size %i' %step)
plt.ylabel('Relative % of action taken')
plt.title('GASP Actions, AvgTrue, MaskAff')
plt.legend()
plt.show()
...
run_GASP_kwargs = {'linkage_criteria': 'abs_max',
                   'add_cannot_link_constraints': True}
dic_mws_True = {}
dic_mws_True['segmentation'], dic_mws_True['runtime'], dic_mws_True['nodeData'], dic_mws_True['edgeData'], _ = utility.gasp(mask_avg_geometry, run_GASP_kwargs, mask_avg_aff_small)
...
plt.xlabel('Interval of size %i' %step)
plt.ylabel('Relative % of action taken')
plt.title('GASP Actions, MWS, MaskAff')
plt.legend()
plt.show()